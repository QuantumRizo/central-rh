...
export function ChangePassword({ session, onBack }: { session: Session; onBack: () => void }) {
  ...
  return <div className="profile-page password-page">
    <div className="profile-heading"><button className="back-link" type="button" onClick={onBack}><ArrowLeft size={17} /> Volver a mi perfil</button><p className="eyebrow">CUENTA Y ACCESO</p><h1>Cambiar contraseña</h1><p>Actualiza la contraseña de tu cuenta para mantener tu acceso seguro.</p></div>
