...
function AdminEvaluacionesPanel({ onViewMine }: { onViewMine: () => void }) {
  ...
  const closeCycle = async (cycle: EvaluationCycle) => {
    ...
    setClosingCycleId(cycle.id); setError('');
    try {
